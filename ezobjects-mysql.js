module.exports.createTable = async (db, obj) => {
  ...
  const mysqlTypesWithpropertylate = [`CHAR`, `VARCHAR`, `TINYTEXT`, `TEXT`, `MEDIUMTEXT`, `LONGTEXT`, `ENUM`, `SET`];
  ...
  const addPropertiesToCreateQuery = (obj) => {
    ...
    obj.properties.forEach((property) => {
      ...
      if ( property.propertylationName && mysqlTypesWithpropertylate.includes(property.mysqlType) )
        createQuery += ` propertyLATE ${property.propertylationName}`;
